    ...
    switch (modalId) {
      case "welcome":
        ...
        var text =
          ...
          "<p><strong>Big update coming soon!</strong> Follow or subscribe to be notified!</p>" +
          '<p class="flex"><a target="_blank" href="https://twitter.com/triviaroyaleio" class="button tiny inline-flex">' +
